        ...
        <div className="login">
            ...
            <div className="login-card">
                ...
                <p className="signup">
                    ...
                    <a onClick={switchToLogin} className="blueclr">
                        Login!
                    </a>
                </p>
                ...
                <p className="terms">
                    I agree to the <a className="blueclr">Privacy Policy</a> and{' '}
                    <a className="blueclr">Terms and Services</a>
                </p>
